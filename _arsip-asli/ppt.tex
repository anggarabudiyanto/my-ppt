...
\usepackage{amsmath}
\usepackage{amsthm, amssymb, amsfonts, latexsym, mathtools, thmtools, bbm}
\usepackage{ragged2e}
\graphicspath{{images/}{./}}
\usepackage{booktabs}
\usepackage{calligra}
...
\usepackage{tikz}
% \usepackage{appendixnumberbeamer} % Uncomment if needed

% Other configurations and commands
...
\usepackage{caption}
\DeclareCaptionLabelFormat{noname}{Gambar #2.\hspace{0.1em}}
\DeclareCaptionLabelSeparator{separatorbaru}{ }
\captionsetup{labelsep=separatorbaru, labelformat=noname}
% Judul referensi untuk beamer
% Ganti judul "References" menjadi "Referensi"
...
\definecolor{telu}{RGB}{148, 0, 0}
\definecolor{merah}{RGB}{255, 0, 0}
\definecolor{abu}{RGB}{211, 211, 211}
\definecolor{abu1}{RGB}{47 ,79 ,79}
\definecolor{abu2}{RGB}{241, 241, 241}
\setbeamercolor*{structure}{bg=smuBlue, fg=smuBlue}
% Title block and bottom right box color
\setbeamercolor*{palette primary}{use=structure, fg=telu,bg=abu} % Bottom left box and bar between title & top bubbles
\setbeamercolor*{palette secondary}{use=structure, fg=white, bg=telu}
% Probably not used
\setbeamercolor*{palette tertiary}{use=structure, fg=white, bg=smuBlue} 

% Title of each slide
\setbeamercolor{frametitle}{bg=abu1, fg=merah}
...
% Atur lebar dan warna latar belakang untuk bagian bawah footer
\setbeamercolor{author in head/foot}{fg=white, bg=scisGold}
\setbeamerfont{author in head/foot}{size=\tiny} % Gantilah sesuai kebutuhan

\setbeamercolor{nama_}{fg=white, bg=telu}
\setbeamercolor{judul_}{fg=telu, bg=abu2}
\setbeamercolor{tanggal_nomor}{fg=telu, bg=abu}
...
\setbeamertemplate{footline}{%
  ...
  \hspace{-0.08 cm}
  \hbox{%
    \begin{beamercolorbox}[wd=.25\paperwidth,ht=2.25ex,dp=1ex,center]{nama_}%
      \usebeamerfont{author in head/foot}\insertshortauthor
    \end{beamercolorbox}%
    \begin{beamercolorbox}[wd=.5\paperwidth,ht=2.20ex,dp=1ex,center]{judul_}%
      \usebeamerfont{author in head/foot}\insertshorttitle 
    \end{beamercolorbox}%
    \begin{beamercolorbox}[wd=.30\paperwidth,ht=2.20ex,dp=1ex,center]{tanggal_nomor}%
      \usebeamerfont{author in head/foot}\insertshortdate \hspace*{4ex} \insertframenumber{} / \inserttotalframenumber{}
    \end{beamercolorbox}%
  }%
  \vskip0pt%
}
